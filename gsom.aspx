    ...
    <div>
        ...
        <td>
            <FONT size="3" face="Times" COLOR=RED><marquee width=100% behavior=scroll scrollamount=5 scrolldelay=85
                bgcolor=#FFE6CC>Upcoming Event: Anand Bazaar on 27th May</marquee></font> 
        </td>
        </tr>
        </table>
        </div>
...
<div style="float:left;position:relative;width:300px;">       
<asp:Image ID="ImageAnand2016" runat="server" ImageUrl="~/images/AnandBazaar2017_v1.jpg" style="z-index: 1; left: 150px; top: 200px; position: absolute; height:600px; width:800px;right: 149px;" />
</div>
